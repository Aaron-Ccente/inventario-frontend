      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-10 relative overflow-hidden border border-gray-200 dark:border-gray-700">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-lg">Bienvenido al Sistema de Inventario PNP</p>
          </div>
          ...
          <div className="text-center mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              ¿No tienes cuenta?{' '}
              <Link to="/register" className="text-pink-500 dark:text-pink-400 font-semibold hover:text-pink-600 dark:hover:text-pink-300 transition-colors underline decoration-2 underline-offset-2 hover:decoration-pink-400">
                Regístrate aquí
              </Link>
            </p>
          </div>
